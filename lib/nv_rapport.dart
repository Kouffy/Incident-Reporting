...
import 'package:gestion_inscidents/index.dart';
...
import 'colors.dart';
class NvRapport extends StatefulWidget {
  @override
  _NvRapportState createState() => _NvRapportState();
}

class _NvRapportState extends State<NvRapport> {
  ...
  Future addData(File imageFile) async {
    ...
    var uri = Uri.parse("http://soufiixinc.com/incident/addtest.php");
  ...
  return false;
    ...
    child:new Scaffold(
      ...
      body: Padding(
        ...
        items: <String>['routes', 'canaux egout', 'ordures', 'eclairage','environnement']
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              new RaisedButton(
                                onPressed: () {
                                  try{
                                     addData(_image);
                                  Toast.show("Envoyé avec succès", context,duration: Toast.LENGTH_LONG,gravity: Toast.BOTTOM);
                            ...
                            builder: (BuildContext context) =>
                                new Index()));
                                  ...
                                  {
                                    Toast.show("Erreur d'Ajout ", context,duration: Toast.LENGTH_LONG,gravity: Toast.BOTTOM);
                                  }
